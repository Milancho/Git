...
{
    public abstract class MicroWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MicroWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MicroWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MicroDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MicroDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MicroDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MicroDbContext, Task<T>> func)
        {
            T result;
