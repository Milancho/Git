...
namespace Micro.Migrations
{
    ...
    [Migration("20210213164048_Added_Person")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Micro.Entities.Person", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Micro.Tasks.Task", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Micro.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Micro.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Micro.Tasks.Task", b =>
                {
                    b.HasOne("Micro.Entities.Person", "AssignedPerson")
                        .WithMany()
